...
Rails.application.routes.draw do
  ...
  patch '/goals/:goal_id/achievements/:id', to: 'achievements#update'
  put '/goals/:goal_id/achievements/:id', to: 'achievements#update'
  delete '/goals/:goal_id/achievements/:id', to: 'achievements#destroy'
